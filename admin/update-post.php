    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-offset-3 col-md-6">
                ...
                $sql = "SELECT * FROM post LEFT JOIN category ON post.category = category.category_id LEFT JOIN user ON post.author = user.user_id WHERE post.post_id = {$post_id}";
